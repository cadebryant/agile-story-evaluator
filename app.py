...
class INVESTEvaluator:
    ...
    def get_ai_analysis(self, story: str) -> str:
        ...
        if not self.client:
            return "AI analysis requires a valid OpenAI API key. Please add your API key to the environment variables."
    ...
    def generate_improved_story(self, story: str) -> str:
        ...
        if not self.client:
            return "Story improvement requires a valid OpenAI API key. Please add your API key to the environment variables."
